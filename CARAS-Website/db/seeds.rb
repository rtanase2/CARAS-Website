...
<body>    
    ...
    <div class=\"container\">
        <div class=\"row\">
            <div id=\"right\">
                <h1>Forms</h1>
                <p>If you'd like to volunteer for our events, please click the button below to fill out our volunteer form.</p>
                <a href=\"/volunteer-new?lang=en\"><button type=\"button\" class=\"btn btn-default\">Register Online</button></a>
            </div>
        </div>
    </div>", 
lang: "en",
    ...
    <div class=\"container\">
        <div class=\"row\">
            <div id=\"right\">
                <h1>Forms</h1>
                <p>If you'd like to volunteer for our events, please click the button below to fill out our volunteer form.</p>
                <a href=\"/volunteer-new?lang=es\"><button type=\"button\" class=\"btn btn-default\">Register Online</button></a>
            </div>
        </div>
    </div>", 
lang: "es",
